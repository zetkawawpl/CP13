CLASS zcl_ce_rap_agency_znk DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES t_agency_range TYPE RANGE OF zrap_znk_travel_agency_es5-agencyid.
    TYPES t_business_data TYPE TABLE OF zrap_znk_travel_agency_es5.
...
CLASS zcl_ce_rap_agency_znk IMPLEMENTATION.
  ...
  METHOD get_agencies.
    ...
    service_consumption_name = to_upper( 'ZSC_RAP_AGENCY_ZNK' ).
